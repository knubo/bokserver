...
class Book {
	...
	function save($data) {
		if($data["coauthor_id"] == 0) { $data["coauthor_id"] = null;}
		if($data["illustrator_id"] == 0) { $data["illustrator_id"] = null;}
		if($data["translator_id"] == 0) { $data["translator_id"] = null;}
		if($data["editor_id"] == 0) { $data["editor_id"] = null;}
		if($data["placement_id"] == 0) { $data["placement_id"] = null;}
		if($data["series"] == 0) { $data["series"] = null;}
		if($data["publisher_id"] == 0) { $data["publisher_id"] = null;}
